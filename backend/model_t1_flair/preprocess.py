...
class MRIProcessor:
    """
    Class description:
        Preprocessing pipeline for T1-to-FLAIR MRI inference inputs.
    ...
    def __init__(
        ...
        Function description:
            Initialize MONAI transforms for single T1 inputs and paired T1/FLAIR inputs.
    ...
    def preprocess_pair(
        ...
        """
        Function description:
            Preprocess paired T1 and FLAIR MRI volumes with aligned transforms.

        Parameters:
            t1_path (str | Path): Path to the source T1 NIfTI file.
            t2_path (str | Path): Path to the ground-truth FLAIR NIfTI file.
